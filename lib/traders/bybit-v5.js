    ...
    if (this.publicConnection?.readyState === WebSocket.OPEN) {
      ...
      this.#pendingPublicConnection = new Promise((resolve) => {
        ...
        this.publicConnection.onclose = async () => {
          this.publicConnection.onopen = null;
          this.publicConnection.onclose = null;
          this.publicConnection.onerror = null;
          this.publicConnection.onmessage = null;
      ...
      this.#pendingPublicConnection.then(() => {
        this.$$connection(

...
import { $throttle } from './ppp-decorators.js';
...
export class ConditionalOrder {
  ...
  constructor(mainTrader) {
    this.mainTrader = mainTrader;
    this.orderId = this.mainTrader.nextConditionalOrderId();
    this.sourceID = uuidv4();
    this.changedWithThrottle = $throttle(this.changed, 250);
    this.traderEventWithThrottle = $throttle(this.traderEvent, 250);
  }

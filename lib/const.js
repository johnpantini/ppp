...
export const ORDERS = {
  MARKET_DATA_RECORDER: 'market-data-recorder',
...
export const INSTRUMENT_DICTIONARY = {
  ...
  ALOR_MOEX_FX_METALS: 'ALOR_MOEX_FX_METALS',
...
export const TRADERS = {
  ...
  COMBINED_ORDERBOOK: 'combined-orderbook',
  CUSTOM: 'custom'
};
...
export const TRADER_CAPS = {
  ...
  CAPS_CONDITIONAL_ORDERS: 'caps-conditional-orders',
  CAPS_ORDERBOOK: 'caps-orderbook',
  CAPS_CANDLES: 'caps-candles',
...
(function (OPERATION_TYPE) {
  ...
  OPERATION_TYPE[(OPERATION_TYPE['OPERATION_TYPE_LOCATE_FEE'] = 800)] =
    'OPERATION_TYPE_LOCATE_FEE';
...
export const TRADING_STATUS = {
  ...
  DELISTED: 'DELISTED',
  IPO_TODAY: 'IPO_TODAY',
  QUOTATION_RESUMPTION: 'QUOTATION_RESUMPTION',
  SHORT_SALE_RESTRICTION: 'SHORT_SALE_RESTRICTION',
  MARKET_IMBALANCE: 'MARKET_IMBALANCE',
  MARKET_CLOSE_IMBALANCE: 'MARKET_CLOSE_IMBALANCE',
  PRICE_INDICATION: 'PRICE_INDICATION',
  TRADING_RANGE_INDICATION: 'TRADING_RANGE_INDICATION'
};

/**
 * Determines whether a widget is one of the built-in workspace widgets.
 * @param {string} widgetType Persisted widget type identifier.
 * @returns {boolean} False for custom and unknown widget types.
 */
...
/**
 * Resolves provider metadata used to import and route an instrument dictionary.
 * Unknown dictionaries retain undefined metadata; no default provider is chosen.
 * @param {string} dictionary Value from INSTRUMENT_DICTIONARY.
 * @returns {{exchange: string | undefined, broker: string | undefined, exchangeList: string[] | undefined}} Provider and compatible instrument exchanges.
 */
export function getInstrumentDictionaryMeta(dictionary) {
  ...
  switch (dictionary) {
    ...
    case INSTRUMENT_DICTIONARY.UTEX_MARGIN_STOCKS:
      ...
      break;
    case INSTRUMENT_DICTIONARY.ALPACA:
      exchange = EXCHANGE.US;
      broker = BROKERS.ALPACA;
      exchangeList = [EXCHANGE.ALPACA];
    ...
    case INSTRUMENT_DICTIONARY.ALOR_MOEX_SECURITIES:
      ...
      break;
    case INSTRUMENT_DICTIONARY.ALOR_MOEX_FX_METALS:
      exchange = EXCHANGE.MOEX_FX_METALS;
      broker = BROKERS.ALOR;
      exchangeList = [EXCHANGE.MOEX];

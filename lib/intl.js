...
export function getInstrumentMinPriceIncrement(instrument, price) {
  ...
  if (
    derivedMinPriceIncrement < instrument.minPriceIncrement &&
...
export function getInstrumentPrecision(instrument, price) {
  ...
  const pi = getInstrumentMinPriceIncrement(instrument, price);

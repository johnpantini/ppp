var createPoly1305 = (function () {
  ...
  return function (createPoly1305) {
    ...
    if (A)
      (C = y ? require('path').dirname(C) + '/' : __dirname + '/'),
        (D = function (a, c) {
          var d = I(a);
          ...
          return G.readFileSync(a, c ? null : 'utf8');
        }),
        (F = function (a) {
          a = D(a, !0);
    ...
    function ba(a, c, d, e) {
            ...
            if (null !== g && void 0 !== g && 0 !== g) {
              ...
              if (0 < n) {
                ...
                for (var v = 0; v < g.length; ++v) {
                  var l = g.charCodeAt(v);

                  if (55296 <= l && 57343 >= l) {
                    var pa = g.charCodeAt(++v);
      ...
      if (e)
        for (var t = 0; t < e.length; t++) {
          ...
          ca ? (0 === a && (a = ea()), (z[t] = ca(e[t]))) : (z[t] = e[t]);
        }
      ...
      d = (function (g) {
        if ('string' === c)
          if (g) {
            for (var p = Q, n = g + NaN, k = g; p[k] && !(k >= n); ) ++k;

            if (16 < k - g && p.subarray && fa) g = fa.decode(p.subarray(g, k));
            else {
              for (n = ''; g < k; ) {
                var h = p[g++];
    ...
    function ja() {
      ...
      ia = a;
      b.HEAP8 = da = new Int8Array(a);
      b.HEAP16 = new Int16Array(a);
      b.HEAP32 = new Int32Array(a);
      b.HEAPU8 = Q = new Uint8Array(a);
    ...
    if (!W.startsWith(V)) {
      ...
      W = b.locateFile ? b.locateFile(oa, C) : C + oa;
    }
    ...
    function qa() {
      ...
      try {
        if (a == W && M) return new Uint8Array(M);
      ...
      'function' === typeof atob
        ...
        : function (a) {
            ...
            do {
              ...
              64 !== m && (c += String.fromCharCode(f));
              64 !== z && (c += String.fromCharCode(t));
            } while (d < a.length);
    ...
    var ua = {
      a: function (a) {
        ...
        for (var d = 1; 4 >= d; d *= 2) {
          ...
          a: {
            try {
              N.grow((Math.min(2147483648, e) - ia.byteLength + 65535) >>> 16);
              ja();
    ...
    (function () {
      ...
      function d(f) {
        return ra()
          ...
          .then(f, function (m) {
            L('failed to asynchronously prepare wasm: ' + m);
            J(m);
          });
      }
      ...
      if (b.instantiateWasm)
        try {
          ...
          return (
            L('Module.instantiateWasm callback failed with error: ' + f), !1
          );
        }
        ...
        return M ||
          ...
          : fetch(W, { credentials: 'same-origin' }).then(function (f) {
              return WebAssembly.instantiateStreaming(f, e).then(
                c,
                function (m) {
                  L('wasm streaming compile failed: ' + m);
    ...
    var ea = (b.stackSave = function () {
        return (ea = b.stackSave = b.asm.e).apply(null, arguments);
      }),
      ha = (b.stackRestore = function () {
        return (ha = b.stackRestore = b.asm.f).apply(null, arguments);
      }),
      P = (b.stackAlloc = function () {
        return (P = b.stackAlloc = b.asm.g).apply(null, arguments);
      });

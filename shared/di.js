...
export const DI = Object.freeze({
   ...
   * @remarks
   * The respectConnection option is only applicable to elements that descend from PPPElement.
   */
    ...
    Reflect.defineProperty(target, propertyName, {
      get: function () {
        ...
        if (value === void 0) {
          ...
          if (respectConnection && this instanceof PPPElement) {
            const notifier = this.$pppController;
            const handleChange = () => {

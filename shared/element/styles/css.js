...
class CSSPartial extends CSSDirective {
  ...
  bind(el) {
    if (this.styles) {
      el.$pppController.addStyles(this.styles);
    }

    if (this.behaviors.length) {
      el.$pppController.addBehaviors(this.behaviors);
    }
  }

  unbind(el) {
    if (this.styles) {
      el.$pppController.removeStyles(this.styles);
    }

    if (this.behaviors.length) {
      el.$pppController.removeBehaviors(this.behaviors);
    }
  }
}

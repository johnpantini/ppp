  ...
  async saveCloudCredentials() {
    try {
      ...
      try {
        ...
        if (rst !== 'pong') {
          invalidate(this.serviceMachineUrl, {
            errorMessage: i18n.t('invalidURL')
          });
        }
      } catch (e) {
        invalidate(this.serviceMachineUrl, {
      ...
      if (!r3.ok) {
        ...
        let errorMessage = i18n.t('mongoDBProblemWithStatus', r3);

        if (r3.status === 401) errorMessage = i18n.t('invalidMongoDBRealmKeys');
      ...
      if (!r4.ok) {
        ...
        if (r4.status === 404 && r4.details.missing === 'project') {
          invalidate(this.app.toast, {
            errorMessage: i18n.t('projectNotFound', { projectName: 'ppp' })
          });
          ...
          invalidate(this.app.toast, {
            errorMessage: i18n.t('operationFailedWithStatus', r4)
          });
        }
      }
      ...
      if (!r5.ok) {
        ...
        if (r5.status === 417) {
          ...
          invalidate(this.app.toast, {
            errorMessage: i18n.t('operationFailedWithStatus', r5)
          });
        }
      }
      ...
      if (!r6.ok) {
        ...
        invalidate(this.app.toast, {
          errorMessage: i18n.t('operationFailedWithStatus', r6)
        });
      }

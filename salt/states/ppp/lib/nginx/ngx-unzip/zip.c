...
struct zip_t *zip_open_mem(const void *mem, size_t size, int level, char mode) {
  struct zip_t *zip = NULL;
...
int zip_entry_open(struct zip_t *zip, const char *entryname, size_t len) {
  size_t entrylen = 0;
